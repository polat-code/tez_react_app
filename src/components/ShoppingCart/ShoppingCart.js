      ...
      <div className="row d-flex justify-content-center">
        <div className="col-lg-10 col-12 pt-3">
          <div className="d-flex flex-row px-lg-5 mx-lg-5 mobile" id="heading">
            <div className="text-white col-6" id="produc">
              PRODUCTS
            </div>
            <div className="text-white col-2 text-center" id="prc">
              PRICE
            </div>
            <div className="text-white col-2 text-center" id="quantity">
              QUANTITY
            </div>
            <div className="text-white col-2 text-center" id="total">
              TOTAL
            </div>
          </div>
          {items.map((item, index) => (
            ...
            >
              <div className="d-flex flex-row align-items-center col-6">
                ...
                <div
                  className="d-flex flex-column pl-md-3 pl-1"
                  id="productDesc"
                >
                  <div>
          ...
          <div className="d-flex justify-content-end px-lg-5 mx-lg-5">
            <div className="pt-lg-4 pt-2 pb-3">
              <b className="text-white">
                SUBTOTAL<span className="pl-4">${subtotal.toFixed(2)}</span>
              </b>
            </div>
          </div>
        </div>
